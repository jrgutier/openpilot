...
DESCRIPTIONS = {
  ...
  "LongitudinalPersonality": tr_noop(
    ...
    "In very aggressive mode, sunnypilot follows very close at low speeds and smoothly increases distance at highway speeds. " +
...
class TogglesLayout(Widget):
  def __init__(self):
    ...
    self._long_personality_setting = multiple_button_item(
      ...
      buttons=[lambda: tr("Aggressive"), lambda: tr("Standard"), lambda: tr("Relaxed"), lambda: tr("Very Aggressive")],
      button_width=250,
