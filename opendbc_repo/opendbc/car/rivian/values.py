...
class CarControllerParams:
  ...
  STEER_MAX = 438  # 1.75x from 250 for more steering authority
  STEER_MAX_LOOKUP = [9, 17], [613, 438]
  STEER_STEP = 1
  STEER_DELTA_UP = 5  # torque increase per refresh (1.5x from 3)
  STEER_DELTA_DOWN = 8  # torque decrease per refresh (1.5x from 5)
